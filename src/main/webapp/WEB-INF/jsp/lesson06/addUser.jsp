...
<%-- AJAX를 사용하려면 jquery 원본 필요 (slim X) --%>
	...
	<script>
		$(document).ready(function() {
			...
			/* 			$('form').on('submit', function(e){
			 // e.preventDefault(); -> submit 되는것을 막는다. (화면 유지)
			 // alert("서브밋 버튼 클릭");
			 ...
			 if (name == ''){
			 alert("이름을 입력하세요");
			 return false; // submit 안한다는 뜻, submit 이벤트 일때 return false 반드시 사용
			 }
