...
public class Lesson04Ex01Controller {
	@Autowired // BO당 @Autowired 어노테이션 각각 붙여줘야함
	private UserBO userBO;

	// _view
	@RequestMapping(path = "/add_user_view", method = RequestMethod.GET) // GET 방식만 허용하는 메소드
	...
	public String addUser(
			...
			@RequestParam(value = "email", required = false) String email, // NULL허용이면 value를 꼭 붙여야함
